...
package com.shanks.spring.boot.kafka.autoconfigure;
    ...
    public static class Consumer {
        ...
        public Map<String, Object> buildProperties() {
            ...
            if (this.sessionTimeoutMs != null) {
                properties.put(ConsumerConfig.SESSION_TIMEOUT_MS_CONFIG, this.sessionTimeoutMs);
            }
            ...
            if (this.maxPollRecords != null) {
                // kafka 0.9 版本无此变量 properties.put(ConsumerConfig.MAX_POLL_RECORDS_CONFIG, this.maxPollRecords);
